...
$(function () {
    ...
    populateLookupSelect({collection:"majorlogins",apikey:"{{settings.formapikey-majorlogins}}",fieldname:"User", selectfield:"email address"});
  
    // remember to add web api key for this collection too (or use a universal /** key)
    populateLookupSelect({collection:"inci-list",apikey:"{{settings.formapikey-inci-list}}",fieldname:"Ingredient", selectfield:"INCI name"});
